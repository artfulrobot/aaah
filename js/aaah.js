...
(function ($, Drupal, window, document, undefined) {
  ...
  Drupal.behaviors.aaah = {
    ...
    bookshopBoot: function bookshopBoot() {
    ...
    windowResized: function windowResized() {
      ...
      if (window.matchMedia("(max-width: 767px)").matches) {
        if (!$body.hasClass('is-mobile')) {
          // Switch mobile view.
          $body.addClass('is-mobile'); // This code will get run on pages without the header.
        ...
        if ($body.hasClass('is-mobile')) {
          // No (longer) mobile.
          $body.removeClass('is-mobile', 'show-menu'); // This code will get run on pages without the header.
